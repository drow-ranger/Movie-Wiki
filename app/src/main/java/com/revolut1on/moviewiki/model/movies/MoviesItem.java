...
public class MoviesItem implements Parcelable {
    ...
    public MoviesItem(String posterPath, boolean adult, String overview, String releaseDate, List<Integer> genreIds, Integer id,
    ...
    public static final Comparator<MoviesItem> BY_NAME_ALPHABETICAL = new Comparator<MoviesItem>() {
        @Override
        public int compare(MoviesItem movie, MoviesItem t1) {
